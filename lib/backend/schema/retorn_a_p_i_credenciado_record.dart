...
class RetornAPICredenciadoRecord extends FirestoreRecord {
  RetornAPICredenciadoRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('RetornAPICredenciado');

  static Stream<RetornAPICredenciadoRecord> getDocument(
          DocumentReference ref) =>
      ref.snapshots().map((s) => RetornAPICredenciadoRecord.fromSnapshot(s));

  static Future<RetornAPICredenciadoRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => RetornAPICredenciadoRecord.fromSnapshot(s));

  static RetornAPICredenciadoRecord fromSnapshot(DocumentSnapshot snapshot) =>
      RetornAPICredenciadoRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static RetornAPICredenciadoRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      RetornAPICredenciadoRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'RetornAPICredenciadoRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is RetornAPICredenciadoRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createRetornAPICredenciadoRecordData({
  String? id,
  String? situacao,
...
class RetornAPICredenciadoRecordDocumentEquality
    implements Equality<RetornAPICredenciadoRecord> {
  const RetornAPICredenciadoRecordDocumentEquality();

  @override
  bool equals(RetornAPICredenciadoRecord? e1, RetornAPICredenciadoRecord? e2) {
  ...
  @override
  int hash(RetornAPICredenciadoRecord? e) => const ListEquality().hash([
        e?.id,
        e?.situacao,
        e?.dataDaSolicitacao,
  ...
  @override
  bool isValidKey(Object? o) => o is RetornAPICredenciadoRecord;
}
