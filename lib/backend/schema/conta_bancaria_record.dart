...
class ContaBancariaRecord extends FirestoreRecord {
  ContaBancariaRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('contaBancaria');

  static Stream<ContaBancariaRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => ContaBancariaRecord.fromSnapshot(s));

  static Future<ContaBancariaRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => ContaBancariaRecord.fromSnapshot(s));

  static ContaBancariaRecord fromSnapshot(DocumentSnapshot snapshot) =>
      ContaBancariaRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static ContaBancariaRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      ContaBancariaRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'ContaBancariaRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is ContaBancariaRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createContaBancariaRecordData({
...
class ContaBancariaRecordDocumentEquality
    implements Equality<ContaBancariaRecord> {
  const ContaBancariaRecordDocumentEquality();

  @override
  bool equals(ContaBancariaRecord? e1, ContaBancariaRecord? e2) {
  ...
  @override
  int hash(ContaBancariaRecord? e) => const ListEquality().hash([
        e?.usuario,
        e?.banco,
        e?.tipoDeConta,
        e?.agencia,
  ...
  @override
  bool isValidKey(Object? o) => o is ContaBancariaRecord;
}
