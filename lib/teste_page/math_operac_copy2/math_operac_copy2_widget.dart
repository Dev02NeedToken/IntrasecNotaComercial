...
import 'math_operac_copy2_model.dart';
export 'math_operac_copy2_model.dart';

class MathOperacCopy2Widget extends StatefulWidget {
  const MathOperacCopy2Widget({Key? key}) : super(key: key);

  @override
  _MathOperacCopy2WidgetState createState() => _MathOperacCopy2WidgetState();
}

class _MathOperacCopy2WidgetState extends State<MathOperacCopy2Widget> {
  late MathOperacCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MathOperacCopy2Model());
            ...
            children: [
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    while (FFAppState().contador <= _model.numLoop) {
                      ...
                      setState(() {
                        _model.emprestimo =
                            _model.emprestimo + (_model.contin * 2).toDouble();
                      });
                      setState(() {
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    setState(() {
                      _model.addToItemList(0.0);
                    });
                    while (FFAppState().contador <= _model.numLoop) {
                      setState(() {
                        _model.numLoop = _model.numLoop;
                      });
                      setState(() {
                        _model.emprestimo = _model.emprestimo * 12;
                      });
                      setState(() {
                        FFAppState().contador = FFAppState().contador + 1.0;
                      });
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    _model.outCalcOp = await actions.calculaPrestacoes(
                      double.parse(_model.emprestimoController.text),
                      double.parse(_model.mesesController.text),
                      double.parse(_model.mesesController.text),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Align(
                              alignment: AlignmentDirectional(0.0, 0.0),
                              child: Text(
                                _model.outCalcOp!.first.toString(),
                                style: FlutterFlowTheme.of(context).bodyMedium,
                              ),
                            ),
                          ),
