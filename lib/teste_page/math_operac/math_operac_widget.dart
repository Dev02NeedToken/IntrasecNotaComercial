...
import 'math_operac_model.dart';
export 'math_operac_model.dart';

class MathOperacWidget extends StatefulWidget {
  const MathOperacWidget({Key? key}) : super(key: key);

  @override
  _MathOperacWidgetState createState() => _MathOperacWidgetState();
}

class _MathOperacWidgetState extends State<MathOperacWidget> {
  late MathOperacModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MathOperacModel());
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    while (FFAppState().cont <= _model.numLoop) {
                      setState(() {
                      ...
                      setState(() {
                        _model.jurosMes = _model.listPag[FFAppState().cont];
                      });
                      setState(() {
                        FFAppState().cont = FFAppState().cont + 1;
                      });
                    }
              ...
              FFButtonWidget(
                onPressed: () async {
                  setState(() {
                    ...
                    _model.adcResult = _model.adc1! + _model.adc2!;
                  });
                },
                text: 'Button',
                options: FFButtonOptions(
