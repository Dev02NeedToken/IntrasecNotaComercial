...
import 'documento_juridico_model.dart';
export 'documento_juridico_model.dart';

class DocumentoJuridicoWidget extends StatefulWidget {
  const DocumentoJuridicoWidget({Key? key}) : super(key: key);

  @override
  _DocumentoJuridicoWidgetState createState() =>
      _DocumentoJuridicoWidgetState();
}

class _DocumentoJuridicoWidgetState extends State<DocumentoJuridicoWidget> {
  late DocumentoJuridicoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DocumentoJuridicoModel());
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await DocJuridicoRecord.collection
                          .doc()
                          .set(createDocJuridicoRecordData(
