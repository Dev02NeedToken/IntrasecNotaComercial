...
import 'documento_pessoa_fisica_model.dart';
export 'documento_pessoa_fisica_model.dart';

class DocumentoPessoaFisicaWidget extends StatefulWidget {
  const DocumentoPessoaFisicaWidget({Key? key}) : super(key: key);

  @override
  _DocumentoPessoaFisicaWidgetState createState() =>
      _DocumentoPessoaFisicaWidgetState();
}

class _DocumentoPessoaFisicaWidgetState
    extends State<DocumentoPessoaFisicaWidget> {
  late DocumentoPessoaFisicaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DocumentoPessoaFisicaModel());
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await DocFisicoRecord.collection
                          .doc()
                          .set(createDocFisicoRecordData(
